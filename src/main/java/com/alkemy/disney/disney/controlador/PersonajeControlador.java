...
import com.alkemy.disney.disney.error.exception.PersonajeYaExisteException;
...
import com.alkemy.disney.disney.util.converter.PersonajeDtoConverter;
...
public class PersonajeControlador {
    ...
    @ApiOperation(value = "Obtener una lista de personajes",
            notes = "Provee un mecanismo para obtener todos los personajes con paginación, "
                    ...
                    + " \"?direction=\" y se puede cambiar el tamaño"
    ...
    @ApiOperation(value = "Borro personaje",
            notes = "Eliminar un personaje existente,requiero permisos"
                    + " de administrador.")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OK", response = Object.class),
            @ApiResponse(code = 404, message = "Not Found", response = ApiError.class),
