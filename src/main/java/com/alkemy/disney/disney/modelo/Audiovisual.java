...
import com.alkemy.disney.disney.util.serializador.AudiovisualSerializador;
...
public abstract class Audiovisual {
    ...
    @ApiModelProperty(value = "Url de la imagen de la película o serie.", dataType = "String", example = "http://web.com.ar/files/fotos2", required = false, position = 2)
    ...
    @ApiModelProperty(value = "Fecha de lanzamiento de la película o serie.", dataType = "LocalDate", example = "2021-10-21", required = true, position = 4)
    ...
    @ApiModelProperty(value = "Género al que pertenece la película.", dataType = "object", required = true, position = 7)
    @ManyToOne
